# Домашнее задание к занятию "`11.2. Кеширование Redis/memcached`" - Хасаншин М.Р.
...
![Скриншот состояния memcached](1.png "Скриншот состояния memcached")
---
